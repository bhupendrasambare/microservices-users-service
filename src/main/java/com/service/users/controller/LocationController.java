...
public class LocationController {
    ...
    @PostMapping("/states")
    public ResponseEntity<Response> createState(@Valid @RequestBody State state) {
    ...
    public ResponseEntity<Response> updateState(@PathVariable Long id, @Valid @RequestBody State state) {
    ...
    public ResponseEntity<Response> updateCity(@PathVariable Long id, @Valid @RequestBody City city) {
